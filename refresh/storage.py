...
DEFAULTS = dict(theme='refresh', character='theme', tempo=1.0, fps=60, effects=True, depth=True, board_only=False, compact_hud=False, integer_scale=False, high_contrast=False,
...
class Store:
    ...
    def validate(self):
        ...
        for key in ('sound','music','dialogue','effects','smooth','fullscreen','depth','board_only','compact_hud','integer_scale','high_contrast'):
